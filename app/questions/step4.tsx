...
const OnboadingChat = () => {
    ...
    const handleNext = () => {
        navigation.navigate("questions/step5");
    }
            ...
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                <View style={[styles.onboadingChat1, styles.iconLayout]}>
                    ...
                    <View style={[styles.chat2, styles.chat2Layout]}>
                        <Text style={[styles.canYouBriefly, styles.nextTypo]}>Do you have any certifications or
                            qualifications you're particularly proud of or want to build upon?</Text>
                    </View>
